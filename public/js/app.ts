...
interface UIElements {
  ...
  primaryPersonaDisplayContainer: HTMLDivElement | null;
  ...
  aiProfileSelect: HTMLSelectElement | null;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const elements: UIElements = {
    ...
    personalityPromptTextarea: document.getElementById('personality-prompt') as HTMLTextAreaElement | null,
    savePromptButton: document.getElementById('save-prompt-button') as HTMLButtonElement | null,
    resetPromptButton: document.getElementById('reset-prompt-button') as HTMLButtonElement | null,
    promptStatusDiv: document.getElementById('prompt-status') as HTMLDivElement | null,
    generatePersonalityButton: document.getElementById('generate-personality-button') as HTMLButtonElement | null,
    personalityGenerationStatusDiv: document.getElementById('personality-generation-status') as HTMLDivElement | null,
    personalityJsonOutputPre: document.getElementById('personality-json-output') as HTMLPreElement | null,
    ...
    profileCardTemplate: document.getElementById('profile-card-template') as HTMLTemplateElement | null,
    ...
    aiProfileSelect: document.getElementById('ai-profile-select') as HTMLSelectElement | null,
